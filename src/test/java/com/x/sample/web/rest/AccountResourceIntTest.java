package com.x.sample.web.rest;

import com.x.sample.config.Constants;
import com.x.sample.Ck5App;
import com.x.sample.domain.Authority;
import com.x.sample.domain.User;
import com.x.sample.repository.AuthorityRepository;
import com.x.sample.repository.UserRepository;
import com.x.sample.security.AuthoritiesConstants;
import com.x.sample.service.MailService;
import com.x.sample.service.dto.UserDTO;
import com.x.sample.web.rest.errors.ExceptionTranslator;
import com.x.sample.web.rest.vm.KeyAndPasswordVM;
import com.x.sample.web.rest.vm.ManagedUserVM;
import com.x.sample.service.UserService;
...
@SpringBootTest(classes = Ck5App.class)
